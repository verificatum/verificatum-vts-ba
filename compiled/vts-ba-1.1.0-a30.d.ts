...
export declare namespace verificatum {
    ...
    namespace arithm {
        namespace uli {
             ...
             */
            export const WORDSIZE: size_t;
            /**
             * The value 2^WORDSIZE.
             */
            export const TWO_POW_WORDSIZE: size_t;
            /**
             * The word 2^WORDSIZE - 1, i.e., the all-one bit mask.
             */
            export const MASK_ALL: size_t;
            /**
             ...
             */
            export const MAX_LIMBS: size_t;
            /**
             * Maximum number of bits in an uli_t.
             */
            export const MAX_BITS: size_t;
            /**
             * Type of muladd_loop() in C from WebAssembly/TypeScript.
             */
            type mal_type = (byteOffsetA: int32_t, byteOffsetB: int32_t, start: int32_t, end: int32_t, Y: int32_t, i: int32_t, c: int32_t) => int32_t;
            type mml_type = (byteOffsetA: int32_t, byteOffsetB: int32_t, byteOffsetC: int32_t, len: int32_t, xi: int32_t, w: int32_t, yw: int32_t, i: int32_t) => void;
            /**
             ...
             * @returns Copy of x.
             */
            export function copy_uli(x: uli_t, limbs ? : size_t): uli_t;
            /**
             ...
             */
            export function msword(x: uli_t, mask ? : word_t): size_t;
            /**
             ...
             */
            export function iszero(x: int32_t[], s ? : size_t): boolean;
            /**
             ...
             */
            export function add(w: uli_t, x: uli_t, y: uli_t, signed ? : bin_t): void;
            /**
             ...
             */
            export const square_karatsuba: (w: uli_t, x: uli_t, depth: size_t, len ? : size_t) => void;
            /**
             * Sets w = x * x.
             *
             * <p>
             ...
             * @param len - Actual lengths of inputs. Useful when stored in longer arrays.
             */
            export const mul_karatsuba: (w: uli_t, x: uli_t, y: uli_t, depth: size_t, len ? : size_t) => void;
            /**
             * Sets w = x * y.
             *
             * <p>
             ...
             */
            export const reciprocal_word: (d: word_t) => word_t;
            /**
             ...
             */
            export const reciprocal_word_3by2: (d: uli_t) => word_t;
            /**
             ...
             */
            export const div3by2: (r: uli_t, u: uli_t, d: uli_t, neg_d: uli_t, v: word_t) => word_t;
            /**
             ...
             */
            export const div_qr: (w: uli_t, x: uli_t, y: uli_t) => void;
            /**
             ...
             */
            export const modrandom: (w: uli_t, m: uli_t, rs: RandomSource, sd ? : size_t) => void;
            /**
             * Sets w = x * y mod m.
             *
             * <p>
             ...
             * @param m - Modulus.
             */
            export const modmul: (w: uli_t, x: uli_t, y: uli_t, m: uli_t) => void;
            /**
             ...
             */
            export function mul_mont(a: uli_t, x: uli_t, y: uli_t, m: uli_t, mn: size_t, w: word_t): void;
            /**
             ...
             * @param m - Modulus.
             */
            export const modpow_sqrmul: (w: uli_t, b: uli_t, e: uli_t, m: uli_t, getCtx: (m: uli_t) => ModPowCtx) => void;
            /**
             * Sets w = b^e mod m.
             *
             * <p>
             ...
             * @param m - Modulus.
             */
            export const modpow_window: (w: uli_t, b: uli_t, e: uli_t, m: uli_t, getCtx: (m: uli_t) => ModPowCtx) => void;
            /**
             ...
             */
            export const modpowprodtab_inner: (b: uli_t[], m: uli_t) => uli_t[];
            /**
             ...
             */
            export function modpowprodtab(b: uli_t[], m: uli_t, width: size_t): uli_t[][];
            /**
             ...
             */
            export const modpowprod: (w: uli_t, t: uli_t[][], e: uli_t[], m: uli_t, width: size_t) => void;
            /**
             ...
             */
            export const miller_rabin: (n: uli_t, t: size_t, rs: RandomSource) => boolean;
            export {};
        }
        namespace li {
...
//# sourceMappingURL=vts-ba-1.1.0-a30.d.ts.map